        ...
        <div className="container mx-auto px-4 text-center relative z-10">
          <div data-aos="fade-up">
            <h1 className="text-5xl md:text-7xl font-bold text-white mb-6 leading-tight">
              CTRL+<span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-purple-600">THINK</span>
            </h1>
            <p className="text-2xl md:text-3xl text-gray-300 mb-4">
              Ideathon & Pitch Competition
            </p>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
              ...
              <div className="glass-card px-6 py-3 rounded-full">
                ...
                <span className="text-white font-semibold">100+ Participants</span>
              </div>
              <div className="glass-card px-6 py-3 rounded-full">
                <i className="fas fa-trophy mr-2 text-yellow-400"></i>
                <span className="text-white font-semibold">25 Teams</span>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="glass-card p-8 rounded-2xl mb-12">
              ...
              <p className="text-gray-300 text-lg leading-relaxed">
                The competition featured <strong className="text-purple-400">25 participating teams</strong> who 
                presented their innovative ideas across various domains including technology, sustainability, 
                education, and social impact. With over <strong className="text-green-400">100 participants</strong>, 
                the event showcased the entrepreneurial spirit and problem-solving capabilities of young innovators.
              </p>
            </div>
            ...
            <div className="grid md:grid-cols-2 gap-6 mb-12">
              <div className="glass-card p-6 rounded-xl">
                ...
                <p className="text-gray-300">
                  Teams developed creative solutions addressing challenges in technology, 
              ...
              <div className="glass-card p-6 rounded-xl">
                ...
                <h3 className="text-2xl font-bold text-white mb-3">Pitch Competition</h3>
                <p className="text-gray-300">
                  Participants presented their ideas to a panel of expert judges, 
                  showcasing their presentation and communication skills.
                </p>
              </div>
              ...
              <div className="glass-card p-6 rounded-xl">
                ...
                <p className="text-gray-300">
                  25 diverse teams worked together to refine their concepts and develop 
          ...
          <div className="grid md:grid-cols-2 gap-6 max-w-6xl mx-auto">
            <div className="relative h-80 rounded-2xl overflow-hidden group">
              ...
              <div className="absolute bottom-4 left-4 text-white">
                <p className="text-lg font-semibold">Team Presentations</p>
              </div>
            </div>
            ...
            <div className="relative h-80 rounded-2xl overflow-hidden group">
              ...
              <div className="absolute inset-0 bg-gradient-to-t from-black/60 to-transparent"></div>
              <div className="absolute bottom-4 left-4 text-white">
                <p className="text-lg font-semibold">Ideation Sessions</p>
              </div>
            </div>
            ...
            <div className="glass-card p-8 rounded-2xl">
              ...
              <ul className="text-left space-y-3 text-gray-300">
                <li className="flex items-start">
                  ...
                  <span>Fostered entrepreneurial mindset among students</span>
                </li>
                <li className="flex items-start">
                  <i className="fas fa-check-circle text-green-400 mr-3 mt-1"></i>
                  <span>Provided platform for innovative problem-solving</span>
                </li>
                <li className="flex items-start">
                  <i className="fas fa-check-circle text-green-400 mr-3 mt-1"></i>
                  <span>Enhanced presentation and pitching skills</span>
                </li>
                <li className="flex items-start">
                  <i className="fas fa-check-circle text-green-400 mr-3 mt-1"></i>
                  <span>Created networking opportunities with industry experts</span>
                </li>
                <li className="flex items-start">
                  <i className="fas fa-check-circle text-green-400 mr-3 mt-1"></i>
                  <span>Encouraged cross-disciplinary collaboration</span>
                </li>
              </ul>
            </div>
          </div>
          ...
          <div className="max-w-4xl mx-auto text-center">
            <div data-aos="fade-up">
              ...
              <p className="text-lg md:text-xl text-gray-300 mb-8 max-w-3xl mx-auto">
                Relive the memories! Scan the QR code below to access all your photos from CTRL+THINK event.
              </p>
